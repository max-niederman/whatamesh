...
class Gradient {
  constructor(...t) {
    e(this, "el", void 0),
      ...
      e(this, "initGradient", (elementOrSelector) => {
        this.el = elementOrSelector instanceof HTMLCanvasElement ? elementOrSelector : document.querySelector(elementOrSelector);
        this.connect();
        return this;
      });
  }
